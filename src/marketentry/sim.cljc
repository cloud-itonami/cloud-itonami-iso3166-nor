...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (NOR, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up no-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (no-entity-missing -> HARD hold) ==")
