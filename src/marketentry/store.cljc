(ns marketentry.store
  "SSoT for the NOR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems NO" :portal "Doffin"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-no-entity? true :has-no-entity? true
             :requires-orgnr? true :orgnr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NOR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Doffin"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-no-entity? true :has-no-entity? true
             :requires-orgnr? true :orgnr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Doffin"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "NOR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Doffin"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-no-entity? true :has-no-entity? false
             :requires-orgnr? true :orgnr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NOR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Doffin"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-no-entity? true :has-no-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "NOR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Doffin"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-no-entity? has-no-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-no-entity?)  (assoc :engagement/requires-no-entity? requires-no-entity?)
    (some? has-no-entity?)       (assoc :engagement/has-no-entity? has-no-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-no-entity? :engagement/has-no-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-no-entity? (boolean (:engagement/requires-no-entity? m))
     :has-no-entity? (boolean (:engagement/has-no-entity? m))
