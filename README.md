# cloud-itonami-iso3166-nor

Open ISO 3166 Blueprint for **NOR**: Norway.
...
tax registration, and EEA single-market rules in Norway, so the
...
- **Not the government of Norway.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Norwegian-licensed counsel
...
(ISO 3166 `NOR`). Required capabilities:
