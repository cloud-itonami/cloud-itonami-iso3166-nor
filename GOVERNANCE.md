...
`cloud-itonami-iso3166-nor` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Norwegian-licensed counsel or a registered agent for whatever licensed
representation the law of Norway requires for public-procurement
filings.
